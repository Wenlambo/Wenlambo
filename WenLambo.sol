...
Website: https://wenlambo.finance
Telegram: https://t.me/WenLambo1
We-NFT: https://we-nft.io
Previous version: https://bscscan.com/token/0xd8a31016cd7da048ca21ffe04256c6d08c3a2251
*/
...
contract WenLambo is  Initializable ,ContextUpgradeable, BEP20Upgradeable, OwnableUpgradeable {
    using AddressUpgradeable for address;
    using SafeBEP20Upgradeable for IBEP20Upgradeable;
    using SafeMathUpgradeable for uint256;

    // setting variable and mapping address
    ...
    function WenLambo_init() internal initializer {
        __BEP20_init("WenLambo", "WLBO");
        ...
        _BuyliquidityFee = 500; // % of transactions will be kept for liquidity
        _BuymarketingFee = 300; // % of transactions will be kept for marketing wallet
